...
function Footer  () {
  return (
    <footer className="bg-black text-white py-[4rem] px-[3rem]">
        ...
        <div className="flex flex-start gap-[5rem]">
          ...
          <div className='w-[25vw] mr-[4rem]'>
            ...
            <div className="mt-2 flex gap-4 flex-start">
              <input type="email" className="px-2 py-2 w-[400vw] h-[5vh]  bg-transparent focus:outline-none focus:border-black-400 text-gray-500 font-light border border-t-black border-l-black border-r-black border-b-white-200 placeholder-gray-300 " placeholder="Your email address"/>
            ...
            <Link to="/footer-style/FooterStyle"><div className='tracking-tight text-[#b19037] cursor-pointer hover:underline hover:border-[#ffff] w-[18vw]'>Check out the #STYLECHANNEL</div></Link>

            <div className='flex flex-start pt-10 gap-3 w-[40vw] text-[#a8a8a8]'>
            <Link to="/"><div className='text-[12px]  hover:underline'>Terms & conditions</div></Link>
            <Link to="/"><div className='text-[12px]  hover:underline'>Security & Privacy</div></Link>
            <Link to="/"><div className='text-[12px]  hover:underline'> © 2024 Lovisa</div></Link>
            </div>
          </div>
          ...
          <div className='w-[10vw] mx-2'>
            ...
            <Link to='/company'><div className='text-[12px] hover:underline hover:bg-blue text-white"' >The Company</div></Link>
            <Link to="/"><div className='text-[12px]  hover:underline hover:bg-blue text-white'>Investor Centre</div></Link>
            <Link to="/"><div className='text-[12px]  hover:underline hover:bg-blue text-white'>Careers</div></Link>
          </div>

          {/* Section 3 */}
          <div className='w-[15vw] mx-2'>
          <h2 className="text-[16px] my-3" style={{letterSpacing: '1px'}}>NEED HELP</h2>
            <Link to="/"><div className='text-[12px]  hover:underline hover:bg-blue text-white'>Contact Us</div></Link>
            <Link to="/"><div className='text-[12px]  hover:underline hover:bg-blue text-white'>Help Centre</div></Link>
          ...
          <div className='w-[15vw] mx-2'>
            ...
            <Link to="/"><div className='text-[12px]  hover:underline hover:bg-blue text-white'>Care & Size Guide</div></Link>
          ...
          <Link to="/piercing/gift-card"><div className='text-[14px] hover:underline hover:bg-blue text-white'><p>Piercing Gift Card</p></div></Link>
          </div>
        </div>
      </div>
    </footer>
