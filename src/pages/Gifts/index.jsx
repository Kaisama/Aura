        ...
        <>
            <div className='flex mt-10 w-[100%] '>
                ...
                <div className='bg-[#F2F2F2] text-center py-9 px-7 w-[50%] pt-[12%]'>
                    ...
                    <div className="mt-6 pt-9 gap-3 flex flex-row items-center">
                        ...
                        <button type='submit' className="px-6 py-1 rounded text-black border bg-white text-[13px] hover:bg-black hover:text-white transition duration-300 text-center w-[12vw]">Freshwater Pearls</button>
            ...
            <div className="text-right px-1 mt-[20px] flex flex-row-reverse mb-[10vh]">
                ...
                <div className='text-center mt-[6vw]' >
                    ...
                    <button type='submit' className="px-9 py-1 mx-4  mt-5 text-white border bg-black text-sm rounded w-[11vw] ">E-Gift Card</button>
                </div>
